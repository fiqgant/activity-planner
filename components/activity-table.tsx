...
export function ActivityTable({ activities, onDelete, onUpdate, onImport }: ActivityTableProps) {
  ...
  const handleDownload = async () => {
    await exportToExcel(activities, "activity-plan")
  }
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Upload file Excel untuk import data aktivitas
            </p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b bg-muted/40">
                ...
                <th className="text-left py-3 px-2 font-medium">
                  <button className="flex items-center gap-1 hover:text-primary transition-colors" onClick={() => handleSort("category")}>
                    Kategori {getSortIcon("category")}
                  </button>
                </th>
                <th className="text-left py-3 px-2 font-medium">
                  <button className="flex items-center gap-1 hover:text-primary transition-colors" onClick={() => handleSort("startDate")}>
                    Mulai {getSortIcon("startDate")}
                  </button>
                </th>
                <th className="text-left py-3 px-2 font-medium hidden md:table-cell">
                  <button className="flex items-center gap-1 hover:text-primary transition-colors" onClick={() => handleSort("endDate")}>
                    Selesai {getSortIcon("endDate")}
                  </button>
                </th>
                <th className="text-left py-3 px-2 font-medium hidden lg:table-cell">
                  <button className="flex items-center gap-1 hover:text-primary transition-colors" onClick={() => handleSort("duration")}>
                    Durasi {getSortIcon("duration")}
                  </button>
                </th>
                <th className="text-left py-3 px-2 font-medium">
                  <button className="flex items-center gap-1 hover:text-primary transition-colors" onClick={() => handleSort("priority")}>
                    Prioritas {getSortIcon("priority")}
                  </button>
                </th>
                <th className="text-left py-3 px-2 font-medium">
                  <button className="flex items-center gap-1 hover:text-primary transition-colors" onClick={() => handleSort("pic")}>
                    PIC {getSortIcon("pic")}
                  </button>
                </th>
                {(onDelete || onUpdate) && (
                  <th className="text-left py-3 px-2 font-medium w-24 text-muted-foreground">Aksi</th>
                )}
              </tr>
            </thead>
            <tbody>
